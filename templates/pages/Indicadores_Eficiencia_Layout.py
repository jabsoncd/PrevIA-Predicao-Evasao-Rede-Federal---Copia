...
# Botão para abrir/expandir os filtros
if st.button("🔍 Abrir Filtros", type="secondary"):
    st.session_state.expander_open = not st.session_state.expander_open
    st.rerun()

# Expander para filtros (fallback para versões antigas)
with st.expander("🎛️ Filtros Avançados", expanded=st.session_state.expander_open):
    ...
    if st.button("🗑️ Limpar Todos os Filtros", type="secondary", use_container_width=True):
        filtro_chaves = [
