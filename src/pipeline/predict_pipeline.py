...
class InputData:
    ...
    def get_input_data_df(self):
        ...
        try:
            ...
            input_data_dict['total_relationship_count'] = [
                self.total_relationship_count]
            input_data_dict['months_inactive_12_mon'] = [
                self.months_inactive_12_mon]
            input_data_dict['contacts_count_12_mon'] = [
                self.contacts_count_12_mon]
            input_data_dict['credit_limit'] = [self.credit_limit]
            input_data_dict['total_revolving_bal'] = [self.total_revolving_bal]
            input_data_dict['total_amt_chng_q4_q1'] = [
                self.total_amt_chng_q4_q1]
            ...
            input_data_dict['avg_utilization_ratio'] = [
                self.avg_utilization_ratio]
