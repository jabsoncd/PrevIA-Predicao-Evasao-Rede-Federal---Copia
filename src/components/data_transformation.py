...
class DataTransformation:
    ...
    def get_preprocessor(self):
        ...
        try:
            ...
            one_hot_encoding_features = ['sexo',
                                        'renda_familiar',
            ...
            to_drop_features = ['unnamed: 0']

            logging.info(f'Categorical features: {one_hot_encoding_features+list(ordinal_encoding_orders.keys())}.')
