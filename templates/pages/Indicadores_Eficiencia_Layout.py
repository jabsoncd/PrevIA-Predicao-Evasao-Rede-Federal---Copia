...
# CSS com prioridade máxima e cores sólidas
    ...
    fig4 = px.histogram(filtered_df[filtered_df['CATEGORIA_SITUACAO'] == 'Evadidos'],
                        x='RENDA_FAMILIAR',
   ...
   # Exibir o gráfico de Eixo Tecnológico
    ...
    mapa = folium.Map(location=[
                    latitude_centro, longitude_centro], tiles="Cartodb Positron", zoom_start=4.6)
